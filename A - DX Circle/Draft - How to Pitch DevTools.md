...
-   reinventing asynchronous programming
-   fault oblivious programming
-   workflows as code
-   reliability on rails
-   Ry: failure is not an option
-   Maxim: service mesh for long running operations
    -   3 teams own 1 wf each, can call each other thru temporal
    -   in abstract great, but issues:
        -   each team in different namespace

**what we dont say**

-   actors - entity - IOT digital twinning